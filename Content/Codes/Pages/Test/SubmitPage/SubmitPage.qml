            ...
            Rectangle{
                ...
                RowLayout{
                    ...
                    Rectangle{
                        ...
                        //-- User Grade and User Test Time and ... (Circle's) --//
                        Rectangle{
                            ...
                            //-- Image Profile , UserName , Your Grade --//
                            Rectangle{
                                width: parent.width
...
//                                color: "#5500ff00"
                                ...
                                ColumnLayout{
                                    ...
                                    Rectangle{
                                        ...
                                        Label{
                                            ...
                                            font.pixelSize: Qt.application.font.pixelSize * 3.1
                                    ...
                                    Rectangle{
                                        ...
                                        Label{
                                            ...
                                            minimumPixelSize: 10
                                            fontSizeMode: Text.Fit
                                            font.pixelSize: Qt.application.font.pixelSize * 3.9
                            ...
                            Rectangle{
                                ...
                                RowLayout{
                                    ...
                                    //-- Left Circle (True Answer Count) --//
                                    Rectangle{
                                        Layout.preferredWidth: ((parent.width / 3) > parent.height) ? parent.height - 5 : (parent.width / 3) - 5
                                        Layout.preferredHeight: ((parent.width / 3) > parent.height) ? parent.height - 5 : (parent.width / 3) - 5

                                        radius: width / 2

                                        border.color: Util.color_BaseBlue
                                        border.width: root.width > 1280 ? 5 : 4

                                        color: "#eeeeee"

                                        //-- Title --//
                                        Label{
                                            id: lbl_TrueAnswerTitle
                                            width: parent.width * 0.6
                                            height: parent.height / 3
                                            anchors.bottom: lbl_TrueAnswerCount.top
