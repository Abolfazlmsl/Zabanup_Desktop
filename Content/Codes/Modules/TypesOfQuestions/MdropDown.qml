...
Item {
    ...
    property alias qModel: yesNoCombo.model
    ...
    TextArea{
        ...
        RowLayout{
            ...
            QstNumber{
                id: lbl_QNumber
                Layout.preferredWidth: lbl_size.implicitHeight * 1.4
    ...
    //            onCurrentIndexChanged:{
                    fillAnswer(qNumber, currentText)
//                    log(currentText + qNumber)
                }
