...
Item {
    ...
    onSourceObjChanged: {
        ...
        tempText = mainObj[0].text.slice(mainObj[0].text.indexOf('_TRUEFALSENOTGIVEN') , mainObj[0].text.length)
        tempText = tempText.slice(tempText.indexOf('</p>') + 4 , tempText.length)

        mainDescription = mainObj[0].text.slice(0 , mainObj[0].text.indexOf('_TRUEFALSENOTGIVEN'))
